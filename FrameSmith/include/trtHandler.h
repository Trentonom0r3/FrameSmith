...
inline std::pair<ICudaEngine*, IExecutionContext*> TensorRTEngineCreator(
    ...
    bool b1 = profile->setDimensions(inputName.c_str(), OptProfileSelector::kMIN, Dims4{ 1, inputsMin[1], inputsMin[2], inputsMin[3] });
    bool b2 = profile->setDimensions(inputName.c_str(), OptProfileSelector::kOPT, Dims4{ 1, inputsOpt[1], inputsOpt[2], inputsOpt[3]});
    bool b3 = profile->setDimensions(inputName.c_str(), OptProfileSelector::kMAX, Dims4{ 1, inputsMax[1], inputsMax[2], inputsMax[3]});
